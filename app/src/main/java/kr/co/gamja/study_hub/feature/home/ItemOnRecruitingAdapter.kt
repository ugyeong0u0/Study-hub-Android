...
class ItemOnRecruitingAdapter(private val context:Context):RecyclerView.Adapter<ItemOnRecruitingAdapter.MainHolder>(){
    ...
    inner class MainHolder(val binding: HomeItemOnRecruitingBinding) :
        ...
        fun setPosts(studyItem: ContentX?) {
            ...
            studyItem?.let {
                ...
                binding.txtRemainingSeats.text=context.getString(R.string.txt_RemainingSeats,it.leftover)
                val full=it.studyPerson-it.leftover
                binding.txtPeople.text=context.getString(R.string.txt_people,full,it.studyPerson)
                //TODO("요금")
