...
import kr.co.gamja.study_hub.databinding.FragmentCreate03NicknameBinding


class Create03NicknameFragment : Fragment() {
    private var _binding:FragmentCreate03NicknameBinding?=null
    private val binding get() = _binding!!
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding= FragmentCreate03NicknameBinding.inflate(inflater,container,false)
